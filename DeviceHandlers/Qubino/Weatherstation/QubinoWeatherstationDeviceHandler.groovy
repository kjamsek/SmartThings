...
metadata {
	...
	tiles(scale: 2) {
		...
		standardTile("temperatureCh1", "device.temperatureCh1", width: 3, height: 3) {
			state("temperatureCh1", label:'Temp. Ch1: ${currentValue} °', unit:'°', icon: 'st.Weather.weather2')
		}
		...
		standardTile("windTemperature", "device.windTemperature", width: 3, height: 3) {
			state("windTemperature", label:'Out Temp. ${currentValue} °', unit:'°', icon: 'st.Weather.weather2')
		}
		standardTile("windChillTemperature", "device.windChillTemperature", width: 3, height: 3) {
			state("windChillTemperature", label:'W. Chill: ${currentValue} °', unit:'°', icon: 'st.Weather.weather2')
		}
		...
		standardTile("temperatureCh2", "device.temperatureCh2", width: 3, height: 3) {
			state("temperatureCh2", label:'Temp. Ch2: ${currentValue} °', unit:'°', icon: 'st.Weather.weather2')
		}
