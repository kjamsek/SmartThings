...
metadata {
	...
	tiles(scale: 2) {
		valueTile("temperature", "device.temperature") {
			state("temperature", label:'${currentValue} °C', unit:"°", icon: "st.Weather.weather2", backgroundColors: [
				// Celsius Color Range
		...
		standardTile("temperatureCh1", "device.temperatureCh1", width: 3, height: 3) {
			state("temperatureCh1", label:'Temp. Ch1: ${currentValue} °C', unit:'°C', icon: 'st.Weather.weather2')
		}
		...
		standardTile("windVelocity", "device.windVelocity", width: 3, height: 3) {
			state("windVelocity", label:'W. Vel.: ${currentValue} m/s', unit:"m/s", icon: 'st.Weather.weather1')
		}
		
		standardTile("windGust", "device.windGust", width: 3, height: 3) {
			state("windGust", label:'W. Gust: ${currentValue} m/s', unit:"m/s", icon: 'st.Weather.weather1')
		}
		standardTile("windTemperature", "device.windTemperature", width: 3, height: 3) {
			state("windTemperature", label:'Out Temp. ${currentValue} °C', unit:'°C', icon: 'st.Weather.weather2')
		}
		standardTile("windChillTemperature", "device.windChillTemperature", width: 3, height: 3) {
			state("windChillTemperature", label:'W. Chill: ${currentValue} °C', unit:'°C', icon: 'st.Weather.weather2')
		}
		standardTile("rainRate", "device.rainRate", width: 3, height: 3) {
			state("rainRate", label:'Rain: ${currentValue} mm/h', unit:"mm/h", icon: 'st.Weather.weather10')
		}
		...
		standardTile("temperatureCh2", "device.temperatureCh2", width: 3, height: 3) {
			state("temperatureCh2", label:'Temp. Ch2: ${currentValue} °C', unit:'°C', icon: 'st.Weather.weather2')
		}
